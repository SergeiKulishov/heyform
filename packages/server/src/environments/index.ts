...
export const DISABLE_LOGIN_WITH_APPLE =
  helper.isTrue(process.env.DISABLE_LOGIN_WITH_APPLE) ||
...
export const DISABLE_LOGIN_WITH_GOOGLE =
  helper.isTrue(process.env.DISABLE_LOGIN_WITH_GOOGLE) ||
  helper.isEmpty(GOOGLE_LOGIN_CLIENT_ID) ||
  helper.isEmpty(GOOGLE_LOGIN_CLIENT_SECRET)
